...
export const addAttachmentService = (
  request: IAddAttachmentRequest,
  userId: string
...
export const setAttachmentUrlService = (
  request: ISetAttachmentUrlRequest,
  userId: string
): Promise<ISetAttachmentUrlResponse> => {
  return new Promise((resolve, reject) => {
    if (request.boardId === "" || request.boardId === undefined) {
      const rejectResponse = {
        status: "invalid-argument",
                  ...
                  .then((attachmentSnap) => {
                    ...
                    batch
                      ...
                      .then(() => {
                        ...
                        const response: ISetAttachmentUrlResponse = {
                          attachment,
                        };
                        resolve(response);
                        return;
                      ...
                      .catch((err) => {
                        ...
                        const rejectResponse = {
                          status: "internal",
                          message:
                            "Attachment's url wasn't set. There is a problem with the database. Please try again later.",
                        };
                        reject(rejectResponse);
                        return;
                      });
