                  ...
                  .then((commentSnap) => {
                    ...
                    batch
                      ...
                      .then(() => {
                        admin
                          .auth()
                          .getUser(commentSnap.data().authorId)
                          .then((authorRecord) => {
                            const author: IUser = {
                            ...
                            const response: IEditCommentResponse = {
                              comment: comment,
                            };
                            resolve(response);
                            return;
                      ...
                      .catch((err) => {
                        ...
                        const rejectResponse = {
                          status: "internal",
                          message:
                            "Comment was not edited. There is a problem with the database. Please try again later.",
                        };
                        reject(rejectResponse);
                        return;
                      });
