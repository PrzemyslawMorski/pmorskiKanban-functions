...
export const removeAttachmentService = (
  request: IRemoveAttachmentRequest,
  userId: string
): Promise<IRemoveAttachmentResponse> => {
                ...
                getAttachmentSnap(
                  ...
                  .then((attachmentSnap) => {
                    ...
                    batch
                      .commit()
                      .then(() => {
                        const response: IRemoveAttachmentResponse = {
                          ...request,
                        };
                        resolve(response);
                        return;
                      ...
                      .catch((err) => {
                        ...
                        const rejectResponse = {
                          status: "internal",
                          message:
                            "Attachment wasn't deleted. There is a problem with the database. Please try again later.",
                        };
                        reject(rejectResponse);
                        return;
                      });
