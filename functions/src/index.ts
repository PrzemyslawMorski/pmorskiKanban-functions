...
import {
  ...
  setAttachmentUrlService,
} from "./services/addAttachment";
...
export const getBoardMiniatures = functions.https.onCall(
...
export const getBoard = functions.https.onCall(
  (data: IGetBoardRequest, context: CallableContext) => {
...
export const getGravatarUrl = functions.https.onCall(
  (data: IGetGravatarUrlRequest) => {
    return getGravatarUrlService(data.email);
  }
);

export const renameBoard = functions.https.onCall(
  (data: IRenameBoardRequest, context: CallableContext) => {
    return renameBoardService(data.boardId, data.boardName, context.auth.uid)
      .then((response) => {
        return response;
      })
      .catch((err) => {
...
export const createBoard = functions.https.onCall(
  (data: ICreateBoardRequest, context: CallableContext) => {
...
export const deleteBoard = functions.https.onCall(
  (data: IDeleteBoardRequest, context: CallableContext) => {
...
export const createList = functions.https.onCall(
  (data: ICreateListRequest, context: CallableContext) => {
...
export const deleteList = functions.https.onCall(
  (data: IDeleteListRequest, context: CallableContext) => {
...
export const renameList = functions.https.onCall(
  (data: IRenameListRequest, context: CallableContext) => {
    return renameListService(
      data.boardId,
      data.listId,
      data.listName,
      context.auth.uid
...
export const createTask = functions.https.onCall(
  (data: ICreateTaskRequest, context: CallableContext) => {
...
export const deleteTask = functions.https.onCall(
  (data: IDeleteTaskRequest, context: CallableContext) => {
...
export const renameTask = functions.https.onCall(
  (data: IRenameTaskRequest, context: CallableContext) => {
    return renameTaskService(
      data.boardId,
      data.listId,
      data.taskId,
      data.newTaskName,
...
export const changeTaskDescription = functions.https.onCall(
  (data: IChangeTaskDescriptionRequest, context: CallableContext) => {
    return changeTaskDescriptionService(
      data.boardId,
      data.listId,
      data.taskId,
...
export const moveList = functions.https.onCall(
  (data: IMoveListRequest, context: CallableContext) => {
    return moveListService(data, context.auth.uid)
      .then((response) => {
        return response;
      })
      .catch((err) => {
...
export const moveTask = functions.https.onCall(
  (data: IMoveTaskRequest, context: CallableContext) => {
    return moveTaskService(data, context.auth.uid)
      .then((response) => {
        return response;
      })
      .catch((err) => {
...
export const addViewer = functions.https.onCall(
  (data: IAddViewerRequest, context: CallableContext) => {
    return addViewerService(data, context.auth.uid)
      .then((response) => {
        return response;
      })
      .catch((err) => {
...
export const removeViewer = functions.https.onCall(
  (data: IRemoveViewerRequest, context: CallableContext) => {
    return removeViewerService(data, context.auth.uid)
      .then((response) => {
        return response;
      })
      .catch((err) => {
...
export const unsubBoard = functions.https.onCall(
  (data: IUnsubBoardRequest, context: CallableContext) => {
    return unsubBoardService(data, context.auth.uid)
      .then((response) => {
        return response;
      })
      .catch((err) => {
...
export const searchUsersByEmail = functions.https.onCall(
  (data: ISearchUsersRequest, context: CallableContext) => {
    return searchUsersByEmailService(data, context.auth.uid)
      .then((response) => {
        return response;
      })
      .catch((err) => {
...
export const onTaskAttachmentDelete = functions.firestore
  .document("attachments/{attachmentId}")
  .onDelete((snap) => {
    onAttachmentDeletedService(snap);
  });

export const addAttachment = functions.https.onCall(
  (data: IAddAttachmentRequest, context: CallableContext) => {
    return addAttachmentService(data, context.auth.uid)
      .then((response) => {
        return response;
      })
      .catch((err) => {
...
export const removeAttachment = functions.https.onCall(
  (data: IRemoveAttachmentRequest, context: CallableContext) => {
    return removeAttachmentService(data, context.auth.uid)
      .then((response) => {
        return response;
      })
      .catch((err) => {
...
export const setAttachmentUrl = functions.https.onCall(
  (data: ISetAttachmentUrlRequest, context: CallableContext) => {
    return setAttachmentUrlService(data, context.auth.uid)
      .then((response) => {
        return response;
      })
      .catch((err) => {
...
export const addComment = functions.https.onCall(
  (data: IAddCommentRequest, context: CallableContext) => {
    return addCommentService(data, context.auth.uid)
      .then((response) => {
        return response;
      })
      .catch((err) => {
...
export const deleteComment = functions.https.onCall(
  (data: IDeleteCommentRequest, context: CallableContext) => {
    return removeCommentService(data, context.auth.uid)
      .then((response) => {
        return response;
      })
      .catch((err) => {
...
export const editComment = functions.https.onCall(
  (data: IEditCommentRequest, context: CallableContext) => {
    return editCommentService(data, context.auth.uid)
      .then((response) => {
        return response;
      })
      .catch((err) => {
